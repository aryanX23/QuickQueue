export const CTASection = () => {
  return (
    <section className="bg-[#eafafa] dark:bg-slate-900 border-t border-gray-200 dark:border-slate-800 relative overflow-hidden">
      {/* Decorative Circles */}
        ...
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1 text-center items-center">
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              <h2 className="text-text-main dark:text-white tracking-tight text-4xl font-black leading-tight sm:text-5xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-4">
              ...
              <button className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-text-main dark:text-white text-lg font-bold hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
